...
-- Reconciliação de ledger: função já está em produção com este exato corpo
-- (aplicada via SQL direto anteriormente); este apply apenas registra a
-- migration no histórico do Supabase para manter supabase/migrations/ em dia.
