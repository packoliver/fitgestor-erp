...
export const requireSupabaseAuth = createMiddleware({ type: 'function' }).server(
  async ({ next }) => {
    ...
    // A validação do token é delegada integralmente ao getClaims() abaixo.
    // Não validamos o formato aqui para manter compatibilidade com tokens
    // opacos (sb_publishable_* / sb_secret_*) que não seguem o formato JWT.
