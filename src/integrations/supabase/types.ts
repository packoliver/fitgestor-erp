  ...
  public: {
    Tables: {
      ...
      shopify_product_sync_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "shopify_product_sync_jobs_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "shopify_product_sync_jobs_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: true
            referencedRelation: "products"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      enqueue_shopify_product_sync: {
        Args: { _delay_seconds?: number; _product_id: string }
        Returns: string
      }
