    ...
    queryFn: async () => {
      ...
      for (let from = 0; ; from += pageSize) {
        const { data, error } = await supabase
          .from("products")
          .select(`
          id, name, code, unit, color, status, sale_price, promotional_price, cost_price,
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                ...
                const productCode = p.code ?? variants[0]?.sku ?? "—";
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="font-mono text-xs">{productCode}</TableCell>
