...
const sheetVariants = cva(
  "bg-popover text-popover-foreground border border-border shadow-2xl fixed z-50 gap-4 p-6 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
