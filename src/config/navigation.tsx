...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "recebimento-rapido", title: "Entrada de mercadoria", url: "/estoque/recebimento-rapido", icon: ArrowDownToLine,
    perm: "goods_receipt.create", group: "Suprimentos", workspaces: ["employee","admin"], priority: 90,
    essential: true,
    description: "Separe por tamanho, conte e já gere as etiquetas — com ou sem nota fiscal.",
    keywords: ["receber","recebimento","mercadoria","entrada","nota","fornecedor","contagem","grade","etiqueta"] },
