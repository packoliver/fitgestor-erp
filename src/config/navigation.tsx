...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "estoque-entrada", title: "Entrada rápida", url: "/estoque/entrada", icon: ArrowDownToLine,
    ...
    description: "Registre uma entrada ou ajuste simples no estoque.",
    keywords: ["entrada","ajuste","mercadoria","dar entrada"] },
  { id: "recebimentos", title: "Recebimentos", url: "/estoque/recebimentos", icon: ArrowDownToLine,
    perm: "goods_receipt.create", group: "Estoque", workspaces: ["employee","admin"], priority: 70,
    essential: true,
    description: "Confira mercadorias, fornecedores, custos e quantidades recebidas.",
    keywords: ["receber","recebimento","mercadoria","nota","fornecedor"] },
